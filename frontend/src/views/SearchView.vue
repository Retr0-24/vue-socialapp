...
<template>
  <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
    <!-- Input Field Search leftside -->
    <div class="main-left col-span-3 space-y-4">
        <div class="bg-white border border-gray-200 rounded-lg">
            <div class="p-4 flex space-x-4">
                <input type="search" class="p-4 w-full bg-gray-100 rounded-lg" placeholder="What are you thinking?"></input>
                <a href="#" class="inline-block py-4 px-6 bg-purple-600 text-white rounded-lg">Post</a>
            </div>
        </div>
        <!-- Profile Proposals Search leftside -->
    ...
    <!-- People you may know Search rightside -->
     <div class="main-right col-span-1 space-y-4">
      <PeopleYouKnow />
      <!-- Trends Search rightside -->
      <Trends />
    </div>
</div>
</template>
